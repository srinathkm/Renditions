...
/*
     RIDC utility to download all web renditions for contents from searchResults resultset which are JPG
*/

public class JPGDownload{
...
InputStream fileStream = null;
      ...
      public static void downloadFiles(ResultSet searchResults) throws IdcClientException,SQLException {
                ...
                System.out.println("###### Starting JPG Files Download ######"); 
		...
		try{
                         ...
                         //for (DataObject search : searchResults.get(i).getRows())
                           while(searchResults.next()){
                             //System.out.println("Downloading JPG : " + "" + searchResults.getRow());
                             if (searchResults.getString("dWebExtension") != null && !searchResults.getString("dWebExtension").isEmpty() && searchResults.getString("dWebExtension").equals("jpg"))
                               {
                                 count++;
                                 System.out.println("Downloading JPG File # :" + " " + count + " " + "and Content ID is : " + " " + searchResults.getString("dDocName"));
			         // Create a new IdcClient Connection using idc protocol (i.e. socket connection to Content Server)
			           ...
			           HdaBinderSerializer serializer = new HdaBinderSerializer ("UTF-8", idcClient.getDataFactory ());
                              ...
                              FileOutputStream fos = new FileOutputStream(prop.getProperty("JPGDownloadPath")+searchResults.getString("dDocName")+"."+searchResults.getString("dWebExtension"));
